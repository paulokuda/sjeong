        ...
        <Parallax className="about-me-panel__paralax" y={["550px", "-1850px"]} styleOuter={{ width: props.isMobileScreen ? "92vw" : "50vw", position: "absolute", top: getTopValue(), right: 0 }}>
          <div className="about-me-panel">
            ...
            <div className="about-me__text-section">
              ...
              <br></br>
              <br></br>
              When I’m not designing, I love to cook for friends, stalk other people’s cats, and curate my <span className="black-text" onMouseEnter={() => setShowTwitterCard(true)} onMouseLeave={() => setShowTwitterCard(false)}><a href="https:/www.instagram.com/jeongsteph" target="_blank" rel="noopener">[Twitter]</a></span> or <span className="black-text" onMouseEnter={() => setShowInstagramBackground(true)} onMouseLeave={() => setShowInstagramBackground(false)}><a href="https:/www.instagram.com/jeongsteph" target="_blank" rel="noopener">[Instagram]</a></span> with dumb shit only. If you’re as funny as me, please say hello. Thanks for stopping by! 
              </div>
          </div>
        </Parallax>
      </ParallaxProvider>
      <div className={`client-wrapper ${slideInLanding ? "client-wrapper__after" : ""}`}>
        <ParallaxProvider>
          <div className="client-landing" style={{ position: (isLandingInView || props.isMobileScreen) ? "fixed" : "relative" }}>
            ...
            <div className="client-landing__item client-list-message-me"><a href="mailto:jeongsteph@gmail.com" target="_blank" rel="noopener"><FlashingText>[MESSAGE ME]</FlashingText></a></div>
          </div>
